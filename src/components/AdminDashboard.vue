...
export default {
  name: "AdminDashboard",
  props: {
    currentUser: String, // This will be passed from the parent
    msg: {
      type: String,
      required: true,
    },
      ...
      navItems: [
        {
          ...
          image: require("@/assets/images.jpg"), // Add your image path
        },
        {
          title: "Products",
          ...
          image: require("@/assets/istockphoto-1414801672-612x612.jpg"), // Add your image path
        },
        {
          title: "Customers",
          ...
          image: require("@/assets/the-value-of-loyal-customer-cover3.webp"), // Add your image path
        },
        {
          title: "Reports",
          description: "Generate sales reports and analyze performance.",
          link: "/adminreports",
          buttonText: "View Reports",
          image: require("@/assets/84584187-0a09-437f-a600-70ef86afc97a.jpg"), // Add your image path
        },
      ],
    };
  },
